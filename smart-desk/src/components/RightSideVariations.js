...
class RightSideVariations extends Component {
  ...
  render() {
    ...
    return (
      <div> <br></br>
        <h3 className = "support"> <u>Right Side Table Variations</u> </h3> <br></br>
        <p className = "support">The three variations in the design of the right side tablet-charger: </p>
        ...
        <p className = "support"> What this means is that the user is either able to wirelessly charge their tablet while it is facing upwards, or can attach the removable stand pieces (that stay either straight or pivot towards user at a 30 degree angle) to charge their tablet upright so they may be able to use it while working. </p>
